    ...
    <section class="mx-auto max-w-6xl flex flex-col lg:flex-row mb-4">
      <article class="lg:w-1/3 bg-white rounded p-4 shadow mt-4 mx-4">
        ...
        <div class="pt-4 flex flex-row gap-4 justify-center">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="currentColor" style="color: #1da1f2"
            viewBox="0 0 24 24">
            <path
      ...
      <article class="lg:w-2/3 mx-4">
        <NuxtLink to="/blog/welcome">
          ...
          <img src="/_ipx/w_724/images/mom-girls-dress-up.png" alt="Welcome to This is my Momoir"
